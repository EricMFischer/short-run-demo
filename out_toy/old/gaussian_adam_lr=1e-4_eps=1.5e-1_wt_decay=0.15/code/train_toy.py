...
EXP_DIR = './out_toy/gaussian_adam_lr=1e-4_eps=1.5e-1_wt_decay=0.15/'
...
if config['toy_type'] == 'gmm_2':
    optim = optim_bank[config['optimizer_type']](f.parameters(), lr=config['lr_init'], eps=1e-6, weight_decay=0.15)
else:
