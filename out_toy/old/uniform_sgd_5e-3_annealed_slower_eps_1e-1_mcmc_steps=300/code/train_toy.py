...
EXP_DIR = './out_toy/uniform_sgd_5e-3_annealed_slower_eps_1e-1_mcmc_steps=300/'
...
for i in range(config['num_train_iters']):
    ...
    if config['toy_type'] == 'gmm_2' and i+1 in [5000,10000,15000,20000]: # [25000, 50000, 75000, 100000]
